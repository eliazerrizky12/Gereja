...
export const blogs: Blog[] = [
  {
    ...
    slug: "rancangan-jadwal-konferensi-daerah-xxxiv",

    title: "Rancangan Jadwal Acara Konferensi Daerah XXXIV GKII DMKB",

    excerpt:
      "Berikut kami sampaikan rancangan jadwal pelaksanaan Konferensi Daerah XXXIV GKII Daerah Mahakam, Kutai Barat yang akan dilaksanakan pada tanggal 08–11 Juli 2026 di GKII Barong Tongkok.",

    coverImage: "/blog/konferensi-daerah-xxxiv.jpeg",
    ...
    tags: ["Konferensi", "GKII", "DMKB", "Barong Tongkok"],

    content: [
      "Shalom Bapak/Ibu, Saudara/i yang terkasih di dalam Tuhan Yesus Kristus.",

      "Melalui pengumuman ini kami menyampaikan rancangan jadwal pelaksanaan Konferensi Daerah XXXIV GKII Daerah Mahakam, Kutai Barat yang akan diselenggarakan di GKII Barong Tongkok.",

      "Konferensi akan berlangsung selama empat hari, mulai tanggal 08 Juli sampai dengan 11 Juli 2026. Seluruh rangkaian acara telah disusun untuk mendukung jalannya persidangan, ibadah, seminar, serta berbagai kegiatan pelayanan lainnya.",

      "Jadwal pada gambar di atas masih berupa rancangan dan dapat mengalami penyesuaian sesuai kebutuhan panitia maupun hasil koordinasi bersama peserta konferensi.",

      "Kami mengajak seluruh jemaat untuk turut mendukung dalam doa agar seluruh persiapan maupun pelaksanaan Konferensi Daerah XXXIV dapat berjalan dengan baik, tertib, dan menjadi berkat bagi setiap peserta yang hadir.",

      "Terima kasih atas perhatian dan dukungan seluruh jemaat. Kiranya Tuhan Yesus Kristus senantiasa menyertai setiap pelayanan kita.",
    ],
  },
  {
    id: "2",
